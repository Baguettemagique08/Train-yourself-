...
export const mockMeasurements: Measurement[] = [
  // Case c1 — Quantity short
  {
    ...
    is_disputed: false,
    quantity_mt: 490.1,
    observed_volume_m3: 493.8,
    temperature_c: 51.2,
    density_at_obs_kgm3: 0.9823,
    density_at_15c_kgm3: 0.9880,
    vcf: 0.9943,
